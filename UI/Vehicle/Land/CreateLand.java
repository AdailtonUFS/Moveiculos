...
import src.Database.Vehicle.LandDatabase;
import src.Database.Vehicle.TruckDatabase;
...
public class CreateLand extends JFrame {
    ...
    public CreateLand() {
        ...
        String[] vehicleOptions = { "Bicicleta", "Carro", "Moto", "Caminhão"};
        ...
        loadLabel.setBounds(23, 405, 65, 19);
        ...
        submitButton.setBounds(77, 405, 80, 25);
        ...
        chooseButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                if (vehicleBox.getSelectedItem().equals("Caminhão")) {
                    loadLabel.setVisible(true);
                    loadField.setVisible(true);
                    submitButton.setBounds(77, 460, 80, 25);
                } else {
                    loadLabel.setVisible(false);
                    loadField.setVisible(false);
                    submitButton.setBounds(77, 405, 80, 25);
        ...
        submitButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                try {
                    ...
                    Database database = new LandDatabase();
                    Land vehicle = new Land(code, name, color, height, width, velocity);

                    if (vehicleType.equals("Caminhão")) {
                        Double load = Double.parseDouble(loadField.getText());
                        vehicle = new Truck(code, name, color, height, width, velocity, load);
                        database = new TruckDatabase();
                    }
